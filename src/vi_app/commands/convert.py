# src\vi_app\commands\convert.py
...
@app.command("folder-to-jpeg", help="Convert supported images under a folder to JPEG.")
def convert_folder_to_jpeg_cmd(
    ...
    # Interactive prompts (like your other modules)
    if src_root is None:
...
@app.command("webp-to-jpeg", help="Convert all .webp images under a folder to JPEG.")
